oma esta db y en donde diga on delete no action , cambialo por on delete set null, y en on update no action coloca on update cascade todo en mayuscula: -- MySQL Workbench Forward Engineering
